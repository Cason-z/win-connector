...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en-US": {
        ...
        "app.subtitle": "Local connection manager for SSH, Telnet, Serial and RDP operations.",
    ...
    "zh-CN": {
        "app.title": "Win Connector",
        "app.brand": "Win Connector",
        "app.subtitle": "面向 SSH、Telnet、串口和 RDP 的本地连接管理器。",
        "header.language": "语言",
        "header.search": "搜索",
        ...
        "filters.group": "分组",
        "filters.all": "全部",
        "filters.summary": "按协议、模板或分组聚焦列表，便于快速运维。",
        "table.name": "名称",
        "table.protocol": "协议",
        ...
        "tasks.summary_idle": "选择连接后可以测试或执行命令。",
